...
defined('FM_SELF_URL') || define('FM_SELF_URL', ($is_https ? 'https' : 'http') . '://' . $http_host . '/page=fileManager');
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a class="float-right text-muted">File Manager <?php echo VERSION; ?></a></div>
        <?php else: ?>
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        //$fm_url = $root_url.'/fileManager.php';
        $this->data = array(
            'lang' => 'en',
